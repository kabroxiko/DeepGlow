...
void Configuration::setDefaultPresets() {
    // Preset 0: Morning Sun
    presets[0].name = "Morning Sun";
    presets[0].brightness = 180;
    presets[0].effect = MODE_AQUARIUM_SUNRISE;
    ...
    // Preset 3: Evening Glow
    presets[3].name = "Evening Glow";
    presets[3].brightness = 120;
    presets[3].effect = MODE_AQUARIUM_GENTLE_WAVE;
    presets[3].params.speed = 60;
    presets[3].params.intensity = 100;
    presets[3].params.color1 = 0xFF6600;  // Orange
    presets[3].params.color2 = 0xFF0066;  // Pink
    
    // Preset 4: Coral Reef
    presets[4].name = "Coral Reef";
    presets[4].brightness = 150;
    presets[4].effect = MODE_AQUARIUM_CORAL_SHIMMER;
    ...
    presets[5].effect = MODE_AQUARIUM_DEEP_OCEAN;
